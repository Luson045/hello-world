...
<div class="container" style="padding:5%;">
    <div class="cards" style="background-color:white;border-radius:5%;padding:2%;">
        <h1>TERMS & CONDITIONS</h1>
            <div style="white-space: pre;overflow:scroll;">Welcome to Hello World!
...
By accessing this website we assume you accept these terms and conditions. Do not continue to use Hello World if you do not agree to take all of the terms and conditions stated on this page.
...
License
Unless otherwise stated, Company Name and/or its licensors own the intellectual property rights for all material on Hello World. All intellectual property rights are reserved. You may access this from Hello World for your own personal use subjected to restrictions set in these terms and conditions.

You must not:

Republish material from Hello World
Sell, rent or sub-license material from Hello World
Reproduce, duplicate or copy material from Hello World
Redistribute content from Hello World
